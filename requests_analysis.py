...
def requests_analysis():
    ...
    for i in requests_list:
        list_list_words.append(str(i).split())
    ...
    # print(list_list_words_without_characters[11591])
    with open('result.txt', 'w', encoding='utf-8') as file:
        for list_request_word in list_list_words_without_characters:
            file.write(f'{str(list_request_word)}\n')
